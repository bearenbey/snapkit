...
ungoogled-chromium-152.0.7977.82-1-x86_64_linux.tar.xz   upstream tarball (the source for the snap)
...
(`152.0.7977.82-1`), and the snap is versioned by the whole tag: a rebuild of
...
```sh
sudo snap install --dangerous ungoogled-chromium_152.0.7977.82-1_amd64.snap
